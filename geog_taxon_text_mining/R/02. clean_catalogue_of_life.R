...
taxa <- read.delim("data/taxa.txt", stringsAsFactors=FALSE, quote = "")

# clean data - selecting the appropriate columns and filtering for animals
new_taxa <- taxa %>%
...
# save as rds file
saveRDS(species_names, "data/unique_COL_species.rds")
